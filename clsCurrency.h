...
public:
    ...
    static bool IsCurrencyExist_CountryName(string CountryName)
    {
    ...
    static double ConvertToUSD(double Amount , clsCurrency Currency)
    {
        return  Amount / Currency.Rate();
    }

    static double ConvertToOtherCurrencyByUSD(double Amount, clsCurrency Currency2)
    {
